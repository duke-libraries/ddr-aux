...
RSpec.describe "API v1 model routing", type: :routing do
  ...
  it "routes GET /api/:model" do
    ...
    expect(get: "/api/languages")
      .to route_to(controller: "api/v1/model", action: "index", model: "languages", format: "json")
  ...
  it "routes GET /api/:model/:id" do
    ...
    expect(get: "/api/languages/1")
      .to route_to(controller: "api/v1/model", action: "show", model: "languages", id: "1", format: "json")
  ...
  it "routes GET /api/:model/find" do
    ...
    expect(get: "/api/languages/find?code=cym")
      .to route_to(controller: "api/v1/model", action: "find", model: "languages", code: "cym", format: "json")
